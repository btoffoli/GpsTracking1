...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    void setMarker() {
        Drawable marker = getResources().getDrawable(R.drawable.barco);
        ItemizedIconOverlay<OverlayItem> overlay = new ItemizedIconOverlay<OverlayItem>(
                new ArrayList<OverlayItem>(), marker, null,
                new DefaultResourceProxyImpl(this));
        // gc: last GeoPoint
        OverlayItem item = new OverlayItem(null, null, new GeoPoint(mLastLocation.getLatitude(), mLastLocation.getLongitude()));
